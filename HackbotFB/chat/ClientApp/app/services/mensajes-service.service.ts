...
export class MensajesServiceService {
  ...
  constructor() {
   ...
   Rellenar(mensajes:MensajesDePersona,parametro:number):void{
    ...
    {
        if(i%2==0)
            mensajes.Mensajes.push({texto:'holaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaholaaholaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'+i,tipo:'llegada'});
        else
            mensajes.Mensajes.push({texto:'holaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'+i,tipo:'enviado'});
    }
};
